...
function clip(s: string, n = 8000): string {//result bohoit bada ho sakta hai web vala to  isliye usko chote chote part me cut kar rahe hai dihane ke liye
    return s.length > n ? s.slice(0, n) + "\n…[truncated]" : s;
}

export function createWebTools(tracker: ActionTracker) {//making a web tools 
    return {
        web_search: tool({
